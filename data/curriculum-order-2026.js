(function applyCurriculumOrder() {
  ...
  const lessonOrder = {
    'sec-html': [
      'block-web-platform-foundations-2026',
      'block-page-structure',
      'block-headings',
      'block-links',
      'block-lists',
      'block-semantic',
      'block-html-a11y-foundations-2026',
      'block-images',
      'block-forms',
      'block-inputs',
      'block-html-a11y-forms-2026',
      'block-tables',
      'block-meta',
      'block-data-attrs',
    ...
    'sec-css': [
      ...
      'block-css-cascade-specificity-2026',
      'block-boxmodel',
      'block-css-values-units-2026',
      'block-css-typography-2026',
      'block-vars',
      'block-css-overflow-controls-2026',
      'block-flexbox',
      'block-grid',
      'block-css-debugging-2026',
      'block-center-button',
    ...
    'sec-js': [
      'block-vars-js',
      'block-js-values-operators-2026',
      'block-strings',
      'block-conditions',
      'block-loops',
      'block-functions',
      'block-js-debugging-2026',
      'block-arrays',
      'block-objects',
      'block-js-json-collections-2026',
      'block-destructuring',
      'block-dom',
      'block-js-security-2026',
      'block-events',
      'block-js-browser-apis-2026',
      'block-js-formdata-url-2026',
      'block-timers',
      'block-localstorage',
    ...
    'sec-ts': [
      'block-ts-basics',
      'block-ts-modules-2026',
      'block-ts-declarations-2026',
    ...
    'sec-react': [
      ...
      'block-react-lists',
      'block-react-hooks',
      'block-react-render-snapshot-2026',
      'block-react-forms',
      'block-react-state-structure-2026',
      'block-react-effects-guidance-2026',
      'block-react-useref',
      'block-react-cleanup',
    ...
    'sec-git': [
      ...
      'block-git-status',
      'block-git-commit',
      'block-git-undo-workflow-2026',
      'block-git-gitignore',
      'block-git-branches',
      'block-git-remote',
      'block-git-sync-workflow-2026',
      'block-git-push',
      'block-git-stash',
      'block-git-conflicts',
    ...
    'sec-node': [
      ...
      'block-node-install',
      'block-node-npm',
      'block-node-modules-runtime-2026',
      'block-node-env',
      'block-node-fs',
      'block-node-event-loop-streams-2026',
      'block-node-zod-validation',
      'block-node-api-styles',
      'block-node-http-errors-2026',
      'block-node-testing-shutdown-2026',
    ...
    'sec-sql': [
      ...
      'block-sql-aggregate',
      'block-sql-keys',
      'block-sql-constraints-normalization-2026',
      'block-sql-joins',
      'block-sql-transactions-isolation',
      'block-sql-indexes',
      'block-sql-explain-pagination-2026',
    ...
    'sec-devops': [
      'block-devops-server',
      'block-devops-web-foundations-2026',
      'block-devops-path',
      'block-devops-docker',
      'block-devops-compose-nginx',
      'block-devops-github-actions',
      'block-devops-observability-release-2026',
      'block-devops-cache',
